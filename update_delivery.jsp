<%-- 
    ...
    Created on : Sep 28, 2019, 8:10:29 PM
...
<html>
    <head>
        ...
        <title>Modify Delivery Boy</title>
        <style>
            h1 {
                display: block;
                font-size: 04em;
    ...
    <body>
        ...
        <table border="1">
            ...
            %>
            <tr>
                <td><%=rs.getString("db_id")%></td>
                <td><%=rs.getString("name")%></td>
                <td><%=rs.getString("address")%></td>
                <td><%=rs.getString("phone_no")%></td>
                <td><a href="update_delivery1.jsp?db_id=<%=rs.getString("db_id")%>">update</a></td>
            </tr>
            <%
                   }
                   con.close();
